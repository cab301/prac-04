...
namespace Question_5
{
    internal class CustomerCollection
    {
        ...
        public void Sort()
        {
            ...
            {
                Customer v = customers[i];
                int j = i - 1;
                while (j >= 0 && customers[j].CompareByNumber(v) > 0)
                {
        ...
        private static int Compare(Customer current, Customer other)
        {
            return current.Number.CompareTo(other.Number);
        }
    }
}
